    ...
    return Card(
      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            Text('Impacto: ${decisao.tempoDeImpactoPositivo.toStringAsFixed(2)}'),
                          ...
                          FractionallySizedBox(
                            ...
                            child: Container(
                              ...
                              child: GestureDetector(
                                ...
                                child: LabeledTextField(label: "Nova Opção", hintText: "Opção nr 1", controller: context.read<DecisionController>().tituloOpcaoCtrl,),
                              ),
                            ),
                          ),
                          ///espaço vertical
                              ...
                              child: IntrinsicHeight(
                                ...
                                children: [
                                  Expanded(
                                    flex:7,
                                    child:
                                 /* LabeledTextField(label: "Tempo de impacto positivo", hintText: "Escreva um número", controller: controller.tempoImpactoPositivoCtrl),
                                 */
                                  Padding(
                                ...
                                onPressed: () {
                                  ...
                                  showDialog(
                                    ...
                                    builder:
                                      ...
                                      content: Text( //para rever depois
                                        "${melhor.titulo} \n Impacto: ${melhor.valorCalculado.toStringAsFixed(2)} \n Custo de implementação: ${melhor.valor} ",
                                      ),
                                      actions: [
                                        TextButton(
                                          onPressed: () => Navigator.pop(context),
